...
const steps = [
  ...
  },
  {
    ...
    subtitle:
      "Phones. Laptops. That TV. The tablet no one admits to using in bed.",
    options: [
      "1-5 devices",
      "6-10 devices",
      "11-15 devices",
      "16+ (basically a hotel)",
    ],
  },
  {
    id: "usage",
    title: "What actually matters to you?",
    subtitle: "Pick your non-negotiables.",
    options: [
      { label: "Video calls", icon: "🎥", hint: "Zoom, Teams, FaceTime" },
      {
        label: "Browsing & email",
        icon: "📧",
        hint: "News, shopping, work stuff",
      },
      ...
      { label: "Streaming", icon: "📺", hint: "Netflix, YouTube, Stan, Binge" },
      {
        label: "Big downloads",
        icon: "📥",
        hint: "Game installs, 4K movies, OS updates",
      },
      {
        label: "Home phone",
        icon: "☎️",
        hint: "VoIP using your landline number",
      },
    ],
  },
];
                ...
                <div key={step.id} className="flex flex-1 items-center">
                  ...
                  >
                    {isCompleted ? (
                      ...
                      <span
                        className={`text-sm font-semibold ${isActive ? "text-skymesh-orange" : "text-slate-400"}`}
                      >
                        {index + 1}
                      </span>
                    )}
                ...
                {current.id === "usage" ? (
                  <>
                    ...
                    <p className="text-center text-xs text-slate-400">
                      This isn't a data grab. it's how we recommend the best
                      plan for you.
                    </p>
                  </>
                ) : (
